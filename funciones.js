...
for(let a=0; a<sobreMenuMi.length;a++){
    sobreMenuMi[a].addEventListener("click",function (){
        ...
        if(a==0){
            ...
            texto.textContent="Nací el  sábado 11 de agosto de 1990,  a las 3:00 de la madrugada aproximadamente"
            texto.style.height="auto";
